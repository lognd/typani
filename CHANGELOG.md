...
- Package metadata: trove classifiers (Python 3.10-3.13, MIT, Typing :: Typed) and keywords on both distributions, so PyPI and badge services report the supported Python versions. No code change.
